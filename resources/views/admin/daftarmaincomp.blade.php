...
@section('content')
<h4>Daftar Peserta Main Comp.</h4>
<div class="card-body">
    ...
    <table class="table table-striped table-bordered display nowrap" id="dataTable" style="width:100%">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <a href="{{ asset("progress/$item->path_progress")}}">{{$item->path_progress}}</a>
          </td>
          <td>
          ...
          <td>
            ...
            {{-- Form Verifikasi --}}
            @if ($item->status != 0)
            <form method="post" action="/daftarmaincomp/verif">
              @csrf
          ...
          <td>
            ...
            {{-- Update Form --}}
            <form method="POST" action="/daftarmaincomp/update">
              @csrf
  ...
  <button class="btn btn-primary" onclick="location.href='/daftarmaincomp/download'">Download All Data</button>
  <button class="btn btn-primary" onclick="location.href='/daftarmaincomp2/download/2'">Download Data Tahap 2</button>
  <button class="btn btn-primary" onclick="location.href='/daftarmaincomp2/download/3'">Download Data Tahap 3</button>
</div>

<!-- Delete Modal-->
<form method="POST" action="/daftarmaincomp/hapus">
  @csrf
