    ...
    <div class="card my-2">
        ...
        <div class="card-body">
            <div class="row">
                ...
                @endif
                @if ($user->daftar == 'devcom' && isset($data->path_abstrak))
                <div class="col-sm-4 my-1">Gambaran Umum</div>
                <a class="col-sm-8 my-1" href="{{asset('abstrak/'.$data->path_abstrak)}}">: {{$data->path_abstrak}}</a>
