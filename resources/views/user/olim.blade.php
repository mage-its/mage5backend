...
<form id="form-utama" method="POST" enctype="multipart/form-data" action="/submitOlim">
    ...
    <div id="main-form">
        ...
        <h3><b>Kode Promo</b></h3>
        <section>
            <div class="form-row align-items-center">
                <div class="form-group col-md-8 ">
                    <label>Promo Code</label>
                    <input type="text" class="upper form-control" id="promo_code"
                        oninput="this.value = this.value.toUpperCase()" name="promo_code" placeholder="Kode Promo...">
                </div>
                <div class="form-group col-md-4 ">
                    <label></label>
                    <input type="button" value="Check" class="btn btn-primary" onclick="Checking()">
                </div>
            </div>
