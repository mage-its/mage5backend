...
<div class="card my-2">
    <div class="card-body">
        ...
        <button class="btn btn-primary" onclick="location.href='/gbolim'">Download</button>
    </div>
</div>

<div class="card my-2">
    <div class="card-body">
        <h3 class="card-title"><b>Soal MAGE 4</b></h3>
        <button class="btn btn-primary" @if (!$data->status_bayar)
            disabled
            @endif
            onclick="location.href='/soalmage4'">Download</button>
    </div>
</div>
...
<div class="card">
    <div class="card-body">
        ...
        <button class="btn btn-primary" onclick="location.href='/gbesport'">Download</button>
    </div>
</div>
@else
...
<div class="card my-2">
    <div class="card-body">
        ...
        <button class="btn btn-primary" onclick="location.href='/gbdevcomp'">Download</button>
    </div>
</div>
