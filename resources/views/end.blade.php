    ...
    <div class="container">
        <div class="row" style="justify-content: center; margin-top: 240px;">
            <div class="col-lg-12">
                ...
                <div class="text-center" style="width: 100%">Perjalanan sudah berakhir, Terima kasih telah mengunjungi bintang ini.</div>
                <br>
                <div class="text-center" id="countdown" style="width:100%">Score Akhir: {{$score}}</div>
