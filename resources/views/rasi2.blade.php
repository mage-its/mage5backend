...
<head>
    ...
    <script type="text/javascript">
        var nodes = null;
            ...
            edges.push({from: 1, to: 8, length: LENGTH_MAIN, width: WIDTH_SCALE * 6, label: '', color:{color: RED}});
            edges.push({from: 1, to: 10, length: LENGTH_MAIN, width: WIDTH_SCALE * 6, label: '', color:{color: RED}});
            ...
            edges.push({from: 3, to: 12, length: LENGTH_MAIN, width: WIDTH_SCALE * 6, label: '', color:{color: RED}});
            edges.push({from: 3, to: 14, length: LENGTH_MAIN, width: WIDTH_SCALE * 6, label: '', color:{color: RED}});
            edges.push({from: 3, to: 15, length: LENGTH_MAIN, width: WIDTH_SCALE * 6, label: '', color:{color: RED}});
            edges.push({from: 3, to: 18, length: LENGTH_MAIN, width: WIDTH_SCALE * 6, label: '', color:{color: RED}});
            edges.push({from: 4, to: 15, length: LENGTH_MAIN, width: WIDTH_SCALE * 6, label: '', color:{color: RED}});
            edges.push({from: 4, to: 16, length: LENGTH_MAIN, width: WIDTH_SCALE * 6, label: '', color:{color: RED}});
            edges.push({from: 5, to: 17, length: LENGTH_MAIN, width: WIDTH_SCALE * 6, label: '', color:{color: RED}});
            ...
            edges.push({from: 8, to: 9, length: LENGTH_MAIN, width: WIDTH_SCALE * 6, label: '', color:{color: RED}});
