...
<body style="overflow-y: hidden;">
    <div class="barAtas">
        <div class="isi">
            <a class="tengahOther" href="index-fix.html"><img id="logoTengah"
                    src="{{asset("Image/logo-mage4.png")}}"></a>
            <nav class="navbar">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 isi-box animated fadeInRight">
                    ...
                    <div class="form-masukan">
                        <input class="masukan" type="text" name="email" placeholder="Email / Username">
