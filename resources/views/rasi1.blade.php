...
<head>
    ...
    <script type="text/javascript">
        var nodes = null;
            ...
            edges.push({from: 1, to: 9, length: LENGTH_MAIN, width: WIDTH_SCALE * 6, label: '', color:{color: RED}});
            edges.push({from: 1, to: 13, length: LENGTH_MAIN, width: WIDTH_SCALE * 6, label: '', color:{color: RED}});
            edges.push({from: 2, to: 10, length: LENGTH_MAIN, width: WIDTH_SCALE * 6, label: '', color:{color: RED}});
            edges.push({from: 2, to: 11, length: LENGTH_MAIN, width: WIDTH_SCALE * 6, label: '', color:{color: RED}});
            edges.push({from: 3, to: 15, length: LENGTH_MAIN, width: WIDTH_SCALE * 6, label: '', color:{color: RED}});
            edges.push({from: 3, to: 16, length: LENGTH_MAIN, width: WIDTH_SCALE * 6, label: '', color:{color: RED}});
            edges.push({from: 4, to: 17, length: LENGTH_MAIN, width: WIDTH_SCALE * 6, label: '', color:{color: RED}});
            edges.push({from: 5, to: 20, length: LENGTH_MAIN, width: WIDTH_SCALE * 6, label: '', color:{color: RED}});
            edges.push({from: 6, to: 7, length: LENGTH_MAIN, width: WIDTH_SCALE * 6, label: '', color:{color: RED}});
            edges.push({from: 8, to: 10, length: LENGTH_MAIN, width: WIDTH_SCALE * 6, label: '', color:{color: RED}});
            edges.push({from: 9, to: 11, length: LENGTH_MAIN, width: WIDTH_SCALE * 6, label: '', color:{color: RED}});
            edges.push({from: 11, to: 12, length: LENGTH_MAIN, width: WIDTH_SCALE * 6, label: '', color:{color: RED}});
            edges.push({from: 12, to: 16, length: LENGTH_MAIN, width: WIDTH_SCALE * 6, label: '', color:{color: RED}});
            edges.push({from: 13, to: 14, length: LENGTH_MAIN, width: WIDTH_SCALE * 6, label: '', color:{color: RED}});
            edges.push({from: 14, to: 15, length: LENGTH_MAIN, width: WIDTH_SCALE * 6, label: '', color:{color: RED}});
            edges.push({from: 15, to: 20, length: LENGTH_MAIN, width: WIDTH_SCALE * 6, label: '', color:{color: RED}});
            edges.push({from: 16, to: 17, length: LENGTH_MAIN, width: WIDTH_SCALE * 6, label: '', color:{color: RED}});
            edges.push({from: 16, to: 18, length: LENGTH_MAIN, width: WIDTH_SCALE * 6, label: '', color:{color: RED}});
            edges.push({from: 18, to: 19, length: LENGTH_MAIN, width: WIDTH_SCALE * 6, label: '', color:{color: RED}});
