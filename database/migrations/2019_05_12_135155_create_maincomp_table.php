...
class CreateMaincompTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('main_comp', function (Blueprint $table) {
            ...
            $table->enum('asal_info',['Media Sosial','Guru','Roadshow','Other'])->nullable();
